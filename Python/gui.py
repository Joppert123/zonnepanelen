...
class Algemeen(Pagina):
   def __init__(self, args):
       ...
       def getSunscreenStatus():
           ...
           sunscreenStatus = int(Transmit(connections[0].ser, command).hex(), 16)
       ...
       def setSunscreenMinExtend():
           command = ("set_sunscreen_min_extend=" + setSunscreenMinExtendField.get())
           response = int(Transmit(connections[0].ser, command).hex(), 16)

       def setSunscreenMaxExtend():
           command = ("set_sunscreen_max_extend=" + setSunscreenMaxExtendField.get())
           response = int(Transmit(connections[0].ser, command).hex(), 16)

       def getManualMode():
           command = "get_sunscreen_manual"
           sunscreenManualmode = int(Transmit(connections[0].ser, command).hex(), 16)
       ...
       getSunscreenStatusButton = tk.Button(self, text="Get Sunscreen Status", width="30", height="2", command=getSunscreenStatus)
       getSunscreenMinExtendButton = tk.Button(self, text="Get Sunscreen Mininmal Extend", width="30", height="2", command=getSunscreenMinExtend)
       getSunscreenMaxExtendButton = tk.Button(self, text="Get Sunscreen Maximum Extend", width="30", height="2", command=getSunscreenMaxExtend)

       # Sunscreen button for set
       setSunscreenMinExtendButton = tk.Button(self, text="Set Sunscreen Mininmal Extend", width="30", height="2", command=setSunscreenMinExtend)
       setSunscreenMaxExtendButton = tk.Button(self, text="Set Sunscreen Maximum Extend", width="30", height="2", command=setSunscreenMaxExtend)

       # Sunscreen manual functions
       sunscreenExtendButton = tk.Button(self, text="Extend Sunscreen", width="30", height="2", command=sunscreenExtend)
       sunscreenRetractButton = tk.Button(self, text="Retract Sunscreen", width="30", height="2", command=sunscreenRetract)

       # Sunscreen button for manual
       getManualModeButton = tk.Button(self, text="Get Manual Mode", width="30", height="2", command=getManualMode)
       setManualModeButton = tk.Button(self, text="Set Manual Mode", width="30", height="2", command=setManualMode)
...
class Temperatuursensor(Pagina):
   def __init__(self, args):
       ...
       getTemperatureButton = tk.Button(self, text="Get Temperature", width="30", height="2", command=getTemperature)
       getMinTempButton = tk.Button(self, text="Get Minimum Temperature", width="30", height="2", command=getMinTemp)
       getMaxTempButton = tk.Button(self, text="Get Maximum Temperature", width="30", height="2", command=getMaxTemp)
       ...
       # Sunscreen button for set
       setMinTempButton = tk.Button(self, text="Set Minimum Temperature", width="30", height="2", command=setMinTemp)
       setMaxTempButton = tk.Button(self, text="Set Maximum Temperature", width="30", height="2", command=setMaxTemp)
...
class Lichtsensor(Pagina):
   def __init__(self, args):
       ...
       getLightButton = tk.Button(self, text="Get Light", width="30", height="2", command=getLight)
       getSonarDistanceButton = tk.Button(self, text="Get Sonar Distance", width="30", height="2", command=getSonarDistance)
